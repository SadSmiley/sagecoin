...
const char * const BITCOIN_CONF_FILENAME = "sagecoin.conf";
const char * const BITCOIN_PID_FILENAME = "sagecoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "SageCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/SageCoin";
#else
    // Unix
    return pathRet / ".sagecoin";
#endif
#endif
}
