...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/sagecoin-project/sagecoin>";
    const std::string URL_WEBSITE = "<https://sagecoin.org>";
