...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s sagecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sagecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sagecoin transaction") + "\n" +
              "  sagecoin-tx [options] -create [commands]   " + _("Create hex-encoded sagecoin transaction") + "\n" +
              "\n";
